                ...
                <table class="table-auto w-full text-left whitespace-no-wrap">
                  <thead>
                    <tr>
                      ...
                      <th class="px-4 py-3 title-font tracking-wider font-medium  bg-gray-100 rounded-tr rounded-br"></th>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="px-4 py-3">
                        <a href="#" data-id="{{$owner->id}}" onclick="deletePost(this)" class="text-white bg-red-400 border-0 px-2 py-2 focus:outline-none hover:bg-red-500 rounded ">完全に削除する</a>
                      </td>
                      </form>
