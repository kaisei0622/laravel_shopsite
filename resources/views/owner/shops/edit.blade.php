                        ...
                        <div class="-m-2">
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                                    ...
                                    <textarea id="information" name="information" rows="10" require
                            ...
                            <div class="p-2 w-full flex justify-around mt-4">
                                ...
                                <button type="submit"
                                    class="text-white bg-black border-0 py-2 px-8 focus:outline-none hover:bg-black rounded text-lg">更新する</button>
                            </div>
                        </div>
                    </form>
                </div>
